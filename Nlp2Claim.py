...
# function that check the scoring patterns and aggregates and prints the final scores
def processResults(finalResults, patternsScoring):
    ...
    print("%s,%s,%s,%s,%s" % (finalScores[0], finalScores[1], finalScores[2], finalScores[3], finalScores[4]))
#def